    ...
    return (
        <div className="flex flex-col items-center justify-start py-24 px-4 w-full">
            <div className="text-center mb-16">
                <div className="w-20 h-20 mx-auto bg-slate-100 dark:bg-slate-800 rounded-2xl flex items-center justify-center text-slate-500 dark:text-slate-600 mb-6 neon-border">
                    <FileText size={40} />
                </div>
            ...
            <div className="w-full max-w-5xl">
                {loading ? (
                    <div className="text-center text-slate-600 py-12 flex items-center justify-center gap-2">
                        ...
                        {posts.map(post => (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-1">
                                    ...
                                    <div className="text-sm text-slate-700 mb-4 mt-auto pt-4 flex items-center justify-between">
