    ...
    if (!post) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center py-24 px-4 w-full text-center">
                ...
                <p className="text-slate-500 mb-8 max-w-md">The article you're looking for might have been removed, or the link is incorrect.</p>
                <button
            ...
            <div className="w-full max-w-3xl">
                ...
                <div
                    className="prose prose-lg md:prose-xl dark:prose-invert max-w-none 
                               ...
                               prose-blockquote:border-primary prose-blockquote:bg-primary/5 prose-blockquote:py-1 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:font-medium prose-blockquote:not-italic"
