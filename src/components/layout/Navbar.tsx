        ...
        <header className="sticky top-0 z-50 glass-effect border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-6">
                    <Link to="/blog" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary transition-colors">{t.nav.blog}</Link>
                    <Link to="/tools" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-neon-pink transition-colors">{t.nav.tools}</Link>
                    <Link to="/arcade" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-green-500 transition-colors">{t.nav.games}</Link>
                    <Link to="/fortune" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-purple-500 transition-colors">{t.nav.fortune}</Link>
                </nav>
